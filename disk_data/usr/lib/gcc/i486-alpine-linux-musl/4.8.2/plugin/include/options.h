...
enum opt_code
{
  ...
  OPT_mstackrealign = 1139,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1140,            /* -mstringop-strategy= */
  OPT_mtbm = 1141,                           /* -mtbm */
  OPT_mtls_dialect_ = 1142,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1143,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1144,                         /* -mtune= */
  OPT_muclibc = 1145,                        /* -muclibc */
  OPT_mveclibabi_ = 1146,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1147,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1148,                    /* -mvzeroupper */
  OPT_mx32 = 1149,                           /* -mx32 */
  OPT_mxop = 1150,                           /* -mxop */
  OPT_mxsave = 1151,                         /* -mxsave */
  OPT_mxsaveopt = 1152,                      /* -mxsaveopt */
  OPT_n = 1153,                              /* -n */
