...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BLDSHARED': 'gcc -shared -static -static-libgcc -static -static-libgcc',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIG_ARGS': "'LDFLAGS=-static -static-libgcc' 'CPPFLAGS=-static' "
                "'--disable-shared' '--with-ensurepip=install' '--with-zlib' "
                "'--enable-nis' '--with-tirpc-include-dir=/usr/include/tirpc' "
                "'--with-gdbm' '--with-decimal=no' '--with-pydebug=no'",
 'CONFINCLUDEDIR': '/usr/local/include',
 'CONFINCLUDEPY': '/usr/local/include/python3.10',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/build/Python-3.10.4/coverage.info',
 'COVERAGE_REPORT': '/build/Python-3.10.4/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include -static',
 'CXX': 'g++',
 ...
 'LDFLAGS': '-static -static-libgcc -static -static-libgcc',
 'LDFLAGS_NODIST': '',
 'LDLIBRARY': 'libpython3.10.a',
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -shared -static -static-libgcc -static -static-libgcc',
 'LDVERSION': '3.10',
 'LIBC': '',
 ...
 'LIBPL': '/usr/local/lib/python3.10/config-3.10-i386-linux-gnu',
 'LIBPYTHON': '',
 ...
 'LN': 'ln',
 'LOCALMODLIBS': '-luuid  -llzma    -ldl -lffi   -lbz2     '
                 '-lrt                                              '
                 '-L/usr/local/lib -lgdbm   -L/usr/local/lib -lz',
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 ...
 'MODBUILT_NAMES': '_uuid  _lzma  _multiprocessing  _queue  _ctypes  '
                   '_ctypes_test  _bz2  _opcode  audioop  ossaudiodev  '
                   '_posixshmem  _lsprof  _testbuffer  _testimportmultiple  '
                   '_testmultiphase  _xxsubinterpreters  _xxtestfuzz  '
                   'xxlimited  xxlimited_35  array  cmath  math  _contextvars  '
                   '_struct  _weakref  _testinternalcapi  _random  '
                   '_elementtree  _pickle  _datetime  _zoneinfo  _bisect  '
                   '_heapq  _asyncio  _json  _statistics  unicodedata  fcntl  '
                   'spwd  grp  select  mmap  _csv  _socket  _crypt  termios  '
                   'resource  _posixsubprocess  _md5  _sha1  _sha256  _sha512  '
                   '_sha3  _blake2  syslog  _gdbm  binascii  zlib  pyexpat  '
                   '_multibytecodec  _codecs_cn  _codecs_hk  _codecs_iso2022  '
                   '_codecs_jp  _codecs_kr  _codecs_tw  xxsubtype  posix  '
 ...
 'MODDISABLED_NAMES': '',
 'MODLIBS': '-luuid  -llzma    -ldl -lffi   -lbz2     '
            '-lrt                                              '
            '-L/usr/local/lib -lgdbm   -L/usr/local/lib -lz',
 'MODOBJS': 'Modules/_uuidmodule.o  Modules/_lzmamodule.o  '
            'Modules/multiprocessing.o Modules/semaphore.o  '
            'Modules/_queuemodule.o  Modules/_ctypes.o Modules/callbacks.o '
            'Modules/callproc.o Modules/stgdict.o Modules/cfield.o  '
            'Modules/_ctypes_test.o  Modules/_bz2module.o  Modules/_opcode.o  '
            'Modules/audioop.o  Modules/ossaudiodev.o  Modules/posixshmem.o  '
            'Modules/_lsprof.o Modules/rotatingtree.o  Modules/_testbuffer.o  '
            'Modules/_testimportmultiple.o  Modules/_testmultiphase.o  '
            'Modules/_xxsubinterpretersmodule.o  Modules/_xxtestfuzz.o '
            'Modules/fuzzer.o  Modules/xxlimited.o  Modules/xxlimited_35.o  '
            ...
            'Modules/_gdbmmodule.o  Modules/binascii.o  Modules/zlibmodule.o  '
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g '
                             ...
                             '-I./Include -static -DPy_BUILD_CORE_BUILTIN',
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                   ...
                   '-I./Include/internal -I. -I./Include -static '
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-static -static-libgcc -static -static-libgcc',
 'PY_CPPFLAGS': '-I. -I./Include -static',
 'PY_ENABLE_SHARED': 0,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-static -static-libgcc -static -static-libgcc',
 'PY_LDFLAGS_NODIST': '',
 ...
 'abs_builddir': '/build/Python-3.10.4',
 'abs_srcdir': '/build/Python-3.10.4',
